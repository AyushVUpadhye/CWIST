...
Measured commit: `037c24d210ca016579fecc63d32771768b3e11ac`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/34917953859. Timestamp: `2026-09-15T01:48:29.164611+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 121,168 | 1.891 | 18.173 | 49.88 | 60.84 | N/A |
| CWIST C1M | 144,478 | 3.077 | 26.353 | 27.01 | 40.16 | 309,482 |
| CWIST C1M arena_max=1 | 145,010 | 3.022 | 24.135 | 24.46 | 37.39 | 300,898 |
| CWIST C1M drain_chunk=8 | 143,952 | 3.051 | 38.040 | 19.47 | 33.02 | 321,238 |
| CWIST C1M PUBLIC_FIXED (opt-in) | 143,541 | 3.104 | 27.308 | 17.00 | 30.32 | 304,919 |
| Axum | 120,775 | 3.238 | 16.252 | 13.69 | 15.82 | 194,290 |
| Gin | 92,056 | 5.459 | 51.092 | 28.18 | 29.61 | 307,312 |
| Spring Boot | 58,813 | 6.757 | 52.506 | 1,257.53 | 1,260.39 | N/A |
...
- CWIST classic: 121,703 req/s; mean 0.497 ms; corrected P99.999 5.139 ms.
- Axum: 126,290 req/s; mean 0.750 ms; corrected P99.999 6.997 ms.
- Spring Boot: 57,797 req/s; mean 1.802 ms; corrected P99.999 30.621 ms.
...
- **CWIST**: 121,703 req/s at 0.50ms average latency (P50 0.42ms, P90 0.85ms, P99 2.06ms)
- **Axum**: 126,290 req/s at 0.75ms average latency (P50 0.67ms, P90 1.30ms, P99 2.44ms), same binary as the main run above
