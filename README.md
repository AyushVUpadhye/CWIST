...
- **CWIST**: 248,393 req/s at 0.26ms average latency (P50 0.20ms, P90 0.43ms, P99 1.74ms)
- **Axum**: 249,558 req/s at 0.38ms average latency (P50 0.34ms, P90 0.66ms, P99 1.16ms), same binary as the main run above
...
Measured commit: `26bc314b42073b8e0f965ef437b8e46b73bbc539`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/35820509107. Timestamp: `2026-09-23T05:09:33.781972+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 235,317 | 1.001 | 25.460 | 48.02 | 58.73 | 2,252,861 |
| CWIST C1M | 305,229 | 1.767 | 24.542 | 24.30 | 37.50 | 704,756 |
| CWIST C1M arena_max=1 | 304,265 | 1.748 | 21.086 | 26.23 | 39.50 | 676,268 |
| CWIST C1M drain_chunk=8 | 306,936 | 1.745 | 22.692 | 24.26 | 37.38 | 688,336 |
| Axum | 246,479 | 1.608 | 8.953 | 14.21 | 16.51 | 465,864 |
| Gin | 188,067 | 3.716 | 61.690 | 27.05 | 28.60 | 870,016 |
| Spring Boot | 125,474 | 3.232 | 64.879 | 1,285.23 | 1,288.11 | 591,905 |
...
- CWIST classic: 248,393 req/s; mean 0.264 ms; corrected P99.999 5.648 ms.
- Axum: 249,558 req/s; mean 0.380 ms; corrected P99.999 3.464 ms.
- Spring Boot: 139,325 req/s; mean 0.867 ms; corrected P99.999 14.216 ms.
