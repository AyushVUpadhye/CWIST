...
Measured commit: `ee9aaf8e2b0639ec2210cfab3a892363a02b2ad8`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/35337173628. Timestamp: `2026-09-18T11:08:08.969187+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 182,783 | 1.284 | 22.464 | 50.73 | 61.69 | N/A |
| CWIST C1M | 216,515 | 2.364 | 22.410 | 19.33 | 32.55 | 494,628 |
| CWIST C1M arena_max=1 | 208,186 | 2.405 | 24.002 | 23.31 | 36.91 | 490,792 |
| CWIST C1M drain_chunk=8 | 212,187 | 2.421 | 23.506 | 18.23 | 31.73 | 497,651 |
| CWIST C1M PUBLIC_FIXED (opt-in) | 215,712 | 2.339 | 23.903 | 16.93 | 30.56 | 480,154 |
| Axum | 178,921 | 2.231 | 14.389 | 14.32 | 16.51 | 291,080 |
| Gin | 119,655 | 4.661 | 52.984 | 27.98 | 29.52 | 439,448 |
| Spring Boot | 109,238 | 3.658 | 35.782 | 1,260.62 | 1,263.50 | N/A |
...
- CWIST classic: 184,560 req/s; mean 0.350 ms; corrected P99.999 4.140 ms.
- Axum: 185,130 req/s; mean 0.546 ms; corrected P99.999 6.198 ms.
- Spring Boot: 117,483 req/s; mean 0.991 ms; corrected P99.999 21.703 ms.
...
- **CWIST**: 184,560 req/s at 0.35ms average latency (P50 0.27ms, P90 0.59ms, P99 1.94ms)
- **Axum**: 185,130 req/s at 0.55ms average latency (P50 0.44ms, P90 1.01ms, P99 2.36ms), same binary as the main run above
