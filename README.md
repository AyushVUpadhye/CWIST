...
Measured commit: `0b590e45d4dbd6a7114de4d96826c55b07a001a4`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/34947921936. Timestamp: `2026-09-15T08:48:24.753159+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 106,080 | 2.178 | 26.469 | 49.55 | 59.86 | N/A |
| CWIST C1M | 138,292 | 3.135 | 24.513 | 19.87 | 33.22 | 284,924 |
| CWIST C1M arena_max=1 | 138,551 | 3.041 | 24.331 | 26.21 | 38.99 | 272,667 |
| CWIST C1M drain_chunk=8 | 134,691 | 3.158 | 25.061 | 19.11 | 32.47 | 271,980 |
| CWIST C1M PUBLIC_FIXED (opt-in) | 137,088 | 3.161 | 32.297 | 16.85 | 29.71 | 273,936 |
| Axum | 109,153 | 3.585 | 15.527 | 13.41 | 15.56 | 193,478 |
| Gin | 77,932 | 6.790 | 89.052 | 27.36 | 28.79 | 291,262 |
| Spring Boot | 43,455 | 9.181 | 93.641 | 1,259.57 | 1,262.44 | N/A |
...
- CWIST classic: 115,803 req/s; mean 0.528 ms; corrected P99.999 5.765 ms.
- Axum: 119,947 req/s; mean 0.787 ms; corrected P99.999 5.325 ms.
- Spring Boot: 44,470 req/s; mean 2.382 ms; corrected P99.999 50.213 ms.
...
- **CWIST**: 115,803 req/s at 0.53ms average latency (P50 0.43ms, P90 0.95ms, P99 2.22ms)
- **Axum**: 119,947 req/s at 0.79ms average latency (P50 0.69ms, P90 1.43ms, P99 2.57ms), same binary as the main run above
