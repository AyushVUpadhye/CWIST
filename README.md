...
Measured commit: `1d44624bee3c14db24e77544fe4ef274bd3971d5`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/35433711305. Timestamp: `2026-09-19T09:15:52.504841+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 116,410 | 1.991 | 21.195 | 48.83 | 59.41 | N/A |
| CWIST C1M | 133,279 | 3.403 | 30.250 | 24.62 | 37.50 | 253,623 |
| CWIST C1M arena_max=1 | 138,565 | 3.056 | 23.716 | 26.15 | 39.06 | 257,626 |
| CWIST C1M drain_chunk=8 | 133,492 | 3.331 | 28.627 | 24.04 | 37.08 | 239,962 |
| CWIST C1M PUBLIC_FIXED (opt-in) | 132,792 | 3.369 | 29.753 | 23.05 | 35.89 | 242,934 |
| Axum | 110,087 | 3.562 | 17.019 | 13.44 | 15.52 | 175,952 |
| Gin | 78,788 | 6.724 | 83.530 | 28.45 | 29.88 | N/A |
| Spring Boot | 43,962 | 9.032 | 78.795 | 1,282.48 | 1,285.34 | N/A |
...
- CWIST classic: 117,205 req/s; mean 0.526 ms; corrected P99.999 10.867 ms.
- Axum: 119,085 req/s; mean 0.789 ms; corrected P99.999 5.285 ms.
- Spring Boot: 45,734 req/s; mean 2.255 ms; corrected P99.999 31.682 ms.
...
|---|---:|---:|---:|---:|---:|---:|
| AMD EPYC 7763 64-Core Processor | 10 | 2.03 | 3.07 | 3.51 | 139,721 | 111,883 |
...
- **CWIST**: 117,205 req/s at 0.53ms average latency (P50 0.41ms, P90 0.98ms, P99 2.24ms)
- **Axum**: 119,085 req/s at 0.79ms average latency (P50 0.69ms, P90 1.44ms, P99 2.54ms), same binary as the main run above
