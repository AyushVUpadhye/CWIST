...
Measured commit: `e734d0842e7b7a007a4219caf1b24c54007b59a1`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/34915461507. Timestamp: `2026-09-15T01:12:21.453466+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 114,025 | 2.007 | 25.633 | 50.90 | 61.55 | N/A |
| CWIST C1M | 140,235 | 2.993 | 23.760 | 19.75 | 32.86 | 257,746 |
| CWIST C1M arena_max=1 | 140,152 | 3.038 | 24.976 | 25.28 | 38.64 | 280,210 |
| CWIST C1M drain_chunk=8 | 134,430 | 3.207 | 28.309 | 20.98 | 40.00 | 268,516 |
| CWIST C1M PUBLIC_FIXED (opt-in) | 138,155 | 3.064 | 63.428 | 16.71 | 29.55 | 269,562 |
| Axum | 112,486 | 3.489 | 18.947 | 14.67 | 16.75 | 183,559 |
| Gin | 79,676 | 6.539 | 69.612 | 27.64 | 29.06 | 283,194 |
| Spring Boot | 39,548 | 10.190 | 111.315 | 1,298.94 | 1,301.81 | N/A |
...
- CWIST classic: 117,346 req/s; mean 0.530 ms; corrected P99.999 5.010 ms.
- Axum: 120,359 req/s; mean 0.784 ms; corrected P99.999 7.006 ms.
- Spring Boot: 44,692 req/s; mean 2.319 ms; corrected P99.999 38.135 ms.
...
- **CWIST**: 117,346 req/s at 0.53ms average latency (P50 0.44ms, P90 0.93ms, P99 2.27ms)
- **Axum**: 120,359 req/s at 0.78ms average latency (P50 0.68ms, P90 1.44ms, P99 2.57ms), same binary as the main run above
