...
Measured commit: `4859b9c55ba9ff05eeb9f98d9e3e5a73abbf1d25`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/34946100451. Timestamp: `2026-09-15T08:30:47.125963+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 110,363 | 2.128 | 28.772 | 50.47 | 60.72 | N/A |
| CWIST C1M | 145,834 | 2.946 | 25.594 | 18.96 | 32.23 | 287,737 |
| CWIST C1M arena_max=1 | 142,388 | 2.999 | 25.309 | 23.97 | 36.73 | 276,131 |
| CWIST C1M drain_chunk=8 | 138,125 | 3.187 | 31.919 | 19.57 | 32.66 | 303,491 |
| CWIST C1M PUBLIC_FIXED (opt-in) | 139,485 | 3.009 | 26.522 | 16.86 | 29.84 | 257,567 |
| Axum | 112,113 | 3.508 | 17.542 | 15.48 | 17.55 | 186,728 |
| Gin | 76,587 | 7.162 | 88.194 | 26.55 | 27.98 | 296,263 |
| Spring Boot | 45,030 | 8.765 | 61.428 | 1,296.18 | 1,299.04 | N/A |
...
- CWIST classic: 120,410 req/s; mean 0.515 ms; corrected P99.999 13.614 ms.
- Axum: 118,763 req/s; mean 0.794 ms; corrected P99.999 5.636 ms.
- Spring Boot: 46,047 req/s; mean 2.235 ms; corrected P99.999 30.161 ms.
...
- **CWIST**: 120,410 req/s at 0.51ms average latency (P50 0.41ms, P90 0.92ms, P99 2.21ms)
- **Axum**: 118,763 req/s at 0.79ms average latency (P50 0.69ms, P90 1.46ms, P99 2.56ms), same binary as the main run above
