...
bool cwist_pfc_request(const cwist_http_request *, const void *route, cwist_endpoint_opt_t,
                       bool middleware, cwist_pfc_key *);
...
bool cwist_pfc_put(cwist_pfc *, const cwist_pfc_key *, const cwist_http_request *,
                   const cwist_http_response *);
