...
int main() {
    ...
    validate("valid", "{\"id\":1,\"name\":\"Widget\",\"price\":9.99,\"stock\":100}");

    /* 2. Missing required field 'price' */
    validate("missing required field", "{\"id\":2,\"name\":\"Gadget\"}");

    /* 3. Wrong type for 'id' */
    validate("wrong type for id", "{\"id\":\"three\",\"name\":\"Doohickey\",\"price\":4.5}");
